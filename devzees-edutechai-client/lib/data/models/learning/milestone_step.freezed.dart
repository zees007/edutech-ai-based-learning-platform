...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MilestoneStep&&(identical(other.index, index) || other.index == index)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.isPrerequisite, isPrerequisite) || other.isPrerequisite == isPrerequisite)&&(identical(other.prerequisite, prerequisite) || other.prerequisite == prerequisite)&&(identical(other.status, status) || other.status == status)&&(identical(other.estimatedMinutes, estimatedMinutes) || other.estimatedMinutes == estimatedMinutes)&&(identical(other.tutorExplanation, tutorExplanation) || other.tutorExplanation == tutorExplanation)&&const DeepCollectionEquality().equals(other.socraticQuestions, socraticQuestions)&&(identical(other.followUpCount, followUpCount) || other.followUpCount == followUpCount)&&const DeepCollectionEquality().equals(other.quiz, quiz)&&(identical(other.quizScore, quizScore) || other.quizScore == quizScore)&&const DeepCollectionEquality().equals(other.userAnswers, userAnswers)&&const DeepCollectionEquality().equals(other.userFullAnswers, userFullAnswers)&&const DeepCollectionEquality().equals(other.videos, videos)&&const DeepCollectionEquality().equals(other.papers, papers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,title,description,isPrerequisite,prerequisite,status,estimatedMinutes,tutorExplanation,const DeepCollectionEquality().hash(socraticQuestions),followUpCount,const DeepCollectionEquality().hash(quiz),quizScore,const DeepCollectionEquality().hash(userAnswers),const DeepCollectionEquality().hash(userFullAnswers),const DeepCollectionEquality().hash(videos),const DeepCollectionEquality().hash(papers));

@override
String toString() {
  return 'MilestoneStep(index: $index, title: $title, description: $description, isPrerequisite: $isPrerequisite, prerequisite: $prerequisite, status: $status, estimatedMinutes: $estimatedMinutes, tutorExplanation: $tutorExplanation, socraticQuestions: $socraticQuestions, followUpCount: $followUpCount, quiz: $quiz, quizScore: $quizScore, userAnswers: $userAnswers, userFullAnswers: $userFullAnswers, videos: $videos, papers: $papers)';
}
...
as List<dynamic>?,followUpCount: null == followUpCount ? _self.followUpCount : followUpCount // ignore: cast_nullable_to_non_nullable
as int,quiz: freezed == quiz ? _self.quiz : quiz // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _MilestoneStep() when $default != null:
return $default(_that.index,_that.title,_that.description,_that.isPrerequisite,_that.prerequisite,_that.status,_that.estimatedMinutes,_that.tutorExplanation,_that.socraticQuestions,_that.followUpCount,_that.quiz,_that.quizScore,_that.userAnswers,_that.userFullAnswers,_that.videos,_that.papers);case _:
  return orElse();
...
@override@JsonKey(name: 'follow_up_count') final  int followUpCount;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MilestoneStep&&(identical(other.index, index) || other.index == index)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.isPrerequisite, isPrerequisite) || other.isPrerequisite == isPrerequisite)&&(identical(other.prerequisite, prerequisite) || other.prerequisite == prerequisite)&&(identical(other.status, status) || other.status == status)&&(identical(other.estimatedMinutes, estimatedMinutes) || other.estimatedMinutes == estimatedMinutes)&&(identical(other.tutorExplanation, tutorExplanation) || other.tutorExplanation == tutorExplanation)&&const DeepCollectionEquality().equals(other._socraticQuestions, _socraticQuestions)&&(identical(other.followUpCount, followUpCount) || other.followUpCount == followUpCount)&&const DeepCollectionEquality().equals(other._quiz, _quiz)&&(identical(other.quizScore, quizScore) || other.quizScore == quizScore)&&const DeepCollectionEquality().equals(other._userAnswers, _userAnswers)&&const DeepCollectionEquality().equals(other._userFullAnswers, _userFullAnswers)&&const DeepCollectionEquality().equals(other._videos, _videos)&&const DeepCollectionEquality().equals(other._papers, _papers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,title,description,isPrerequisite,prerequisite,status,estimatedMinutes,tutorExplanation,const DeepCollectionEquality().hash(_socraticQuestions),followUpCount,const DeepCollectionEquality().hash(_quiz),quizScore,const DeepCollectionEquality().hash(_userAnswers),const DeepCollectionEquality().hash(_userFullAnswers),const DeepCollectionEquality().hash(_videos),const DeepCollectionEquality().hash(_papers));
...
as List<dynamic>?,followUpCount: null == followUpCount ? _self.followUpCount : followUpCount // ignore: cast_nullable_to_non_nullable
as int,quiz: freezed == quiz ? _self._quiz : quiz // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,quizScore: freezed == quizScore ? _self.quizScore : quizScore // ignore: cast_nullable_to_non_nullable
