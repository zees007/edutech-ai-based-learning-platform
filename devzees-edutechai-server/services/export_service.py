"""
EduTechAI — Export Service Layer

Encapsulates formatting and generation logic for session exports:
- Markdown export
- Interactive HTML export
- Styled PDF generation with embedded KaTeX / MathJax equations and Mermaid diagrams
"""
...
class ExportService:
    """Service layer coordinating learning session export operations."""
    ...
    @staticmethod
    def generate_markdown(memory) -> str:
        """Export session content as GitHub-flavored Markdown text."""
        return generate_markdown(memory)

    @staticmethod
    async def generate_pdf(memory) -> bytes:
        """Export session as a branded, styled PDF document with LaTeX & diagrams rendered."""
        return await generate_pdf(memory)

    @staticmethod
    def generate_html(memory) -> str:
        """Export session as a standalone, responsive HTML study guide."""
        return generate_html(memory)
